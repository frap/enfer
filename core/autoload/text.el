...
;;;###autoload
(defun enfer-surrounded-p (pair &optional inline balanced)
...
`enfer/forward-to-last-non-comment-or-eol'."
  (interactive)
  (let ((pos (point))
...
true end of the line. The opposite of `enfer/backward-to-bol-or-indent'."
  (interactive)
...
;;;###autoload
(defun enfer/retab (arg &optional beg end)
...
;;;###autoload
(defun enfer/delete-trailing-newlines ()
...
;;;###autoload
(defun enfer|disable-delete-trailing-whitespace ()
...
;;;###autoload
(defun enfer|enable-show-trailing-whitespace ()
  "Enable `show-trailing-whitespace' in the current buffer."
  (setq-local show-trailing-whitespace t))

;;;###autoload
(defun enfer|disable-show-trailing-whitespace ()
