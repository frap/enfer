...
(def-package! dumb-jump
  ...
  :config
  (setq dumb-jump-default-project enfer-emacs-dir
...
(after! xref
  ...
  (advice-add #'xref-push-marker-stack :around #'enfer*set-jump)
...
(def-package! dash-docs
  ...
  :config
  (setq dash-docs-enable-debugging enfer-debug-mode
        dash-docs-docsets-path (concat enfer-etc-dir "docsets/")
