...
(setq lsp-session-file (concat enfer-etc-dir "lsp-session")
      lsp-auto-guess-root t
      lsp-keep-workspace-alive nil
      lsp-groovy-server-install-dir (concat enfer-etc-dir "groovy-langserver/"))
...
(after! lsp-mode
  ...
  ;; company, and yasnippet. Enfer's modules already handle these just fine, so
  ;; leave it to us.
